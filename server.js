...
app.get('/main/atl/*', function (request, response) {

  response.sendFile(mainATL_path, function (error) {
    if (error) {
      console.log(error);
    }
  });
...
app.get('/landingATL', function (request, response) {
  response.sendFile(landingATL_path, function (error) {
    if (error) {
      console.log(error);
    }
  });
